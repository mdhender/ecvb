...
func FuzzParse(f *testing.F) {
	for _, seed := range []string{
		...
		"game \"TEST\" turn 0\nid faction 1\n\nship 100002 jump to (1,2,3)\n",
		"game \"TEST\" turn 0\nid faction 1\n\ncolony 100005 create ship using 60 STRC-8 with 5 CWKR end\n",
		"game \"TEST\" turn 0\nid faction 1\n\ncolony 100005 sell 100 FOOD 1,000.50 GOLD 75%\n",
		"game \"TEST\" turn 0\nid faction 1\n\nwe name (1,2,3) system A orbit 8 \"x\"\n",
		"game \"TEST\" turn 0\nid faction 1\n\nship 100002 probe system A orbit 1 2 3\n",
		"game \"TEST\" turn 0\nid faction 1\n\ncolony 100005 buy tech-level TL-4 800,000 GOLD\n",
		"(((((,,,,)))))",
		"\t\"\n\"\n#\n,\n",
		"game \"\" turn -0\nid player \"\"\n\nwe name (0,0,0) \"\"\n",
	} {
